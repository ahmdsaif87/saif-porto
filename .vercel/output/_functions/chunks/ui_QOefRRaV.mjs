  ...
  en: {
    projectsContent: {
      dyaCollection: {
        ...
        description: "A modern and responsive e-commerce web application designed for fashion enthusiasts.",
        imageAltText: "Homepage of Dya Collection e-commerce website",
        categoryText: "E-commerce Web",
        dateText: "December 2024",
        detailedDescription: "Dya Collection is a sophisticated e-commerce application designed to provide a premium shopping experience for fashion enthusiasts. It features a clean, high-performance interface that prioritizes user engagement and streamlined navigation.",
        keyFeatures: {
          productCatalog: {
        ...
        outcome: "Dya Collection successfully provides a scalable and efficient e-commerce solution, offering users a seamless journey from product discovery to secure checkout.",
        galleryImages: {}
      },
      alysa: {
        title: "Alysa - IELTS Preparation Platform",
        description: "A comprehensive mobile learning platform designed to help students prepare for the IELTS exam with AI-driven feedback.",
        ...
        detailedDescription: "Alysa is a sophisticated mobile learning application designed to revolutionize IELTS preparation. It provides a unified platform for students to practice all four exam modules with real-time feedback and structured study plans.",
        keyFeatures: {
          practiceTests: {
            title: "Full Practice Tests",
            description: "Complete simulations of the IELTS exam for Listening, Reading, Writing, and Speaking."
          },
          aiFeedback: {
            title: "AI-Driven Feedback",
            description: "Instant, detailed evaluations and scoring for writing and speaking tasks using advanced AI models."
          },
          personalizedPath: {
            title: "Personalized Learning",
            description: "Dynamic study plans that adapt to the user's performance and focus on weak areas."
          }
        },
        technologiesUsed: {
        ...
        outcome: "Alysa delivers a scalable and efficient solution for IELTS students, simplifying the complex process of preparation and enhancing the learning experience through immediate AI feedback.",
        galleryImages: {}
      },
      punkMerch: {
        title: "Punk Merch",
        description: "A stylized e-commerce platform for punk-themed merchandise built with Laravel.",
        imageAltText: "Homepage of Punk Merch e-commerce website",
        categoryText: "E-commerce Web",
        dateText: "November 2024",
        detailedDescription: "Punk Merch is a unique e-commerce application designed to cater to the punk subculture. It provides a specialized platform for merchandise sales, featuring robust backend management and a visually striking frontend.",
        keyFeatures: {
          merchInventory: {
        ...
        outcome: "Punk Merch delivers a specialized e-commerce solution that simplifies interactions between the store and its niche audience, providing a unique and efficient shopping experience.",
        galleryImages: {}
      }
    },
    skillsContent: {
    ...
    homePage: {
      ...
      pageDescription: "Welcome to the portfolio of Ahmad Saif, a FullStack developer passionate about creating innovative web experiences.",
      ...
      heroImageAlt: "Illustration representing Ahmad Saif or a development concept",
      ...
      aboutMeDescription: "I am a passionate Full-Stack developer based in Tegal, Indonesia, with a strong focus on building modern and performant web applications. I love solving complex problems and constantly learning new technologies to stay at the forefront of the industry.",
      ...
      experiences: [
        {
          ...
          company: "Orangaringe",
          date: "2025 - Present",
          description: "Developing Alysa (Mobile Learning Platform for IELTS Preparation) for capstone project, focusing on flask and flutter."
        }
      ],
...
export { useTranslations as a, defaultLanguage as d, languages as l, ui as u };
